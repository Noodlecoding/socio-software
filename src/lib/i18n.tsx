...
const translations = {
  en: {
    ...
    affiliateGuide: {
      ...
      subtitle: 'Before you start prospecting, choose a first-world country where English is commonly spoken (e.g. Australia, France, USA) to focus your outreach on.',
  ...
  es: {
    ...
    affiliateGuide: {
      ...
      subtitle: 'Antes de empezar a prospectar, elige un país de primer mundo donde se hable inglés comúnmente (por ejemplo, Australia, Francia, EE. UU.) para enfocar tu búsqueda.',
