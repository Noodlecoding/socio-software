...
const translations = {
  en: {
    ...
    signupCard: {
      ...
      emailToggleSignup: 'Sign up with email',
    ...
    affiliate: {
      ...
      onboarding: {
        stepOf7Prefix: 'Step',
        stepOf7Suffix: 'of 7',
        dealSizePrompt: 'Client project size',
        commissionRateNote: '23% commission',
        youCouldEarn: 'You could earn per successful referral',
        back: 'Back',
        continue: 'Continue',
    ...
    affiliateGuide: {
      ...
      subtitlePrefix: 'Before you start prospecting, ',
      subtitleBold: 'choose a first-world country where English is commonly spoken (e.g. Australia, France, USA)',
      subtitleSuffix: ' to focus your outreach on.',
  ...
  es: {
    ...
    signupCard: {
      ...
      emailToggleSignup: 'Regístrate con correo',
    ...
    affiliate: {
      ...
      onboarding: {
        stepOf7Prefix: 'Paso',
        stepOf7Suffix: 'de 7',
        dealSizePrompt: 'Tamaño del proyecto del cliente',
        commissionRateNote: '23% de comisión',
        youCouldEarn: 'Podrías ganar por referido exitoso',
        back: 'Atrás',
        continue: 'Continuar',
    ...
    affiliateGuide: {
      ...
      subtitlePrefix: 'Antes de empezar a prospectar, ',
      subtitleBold: 'elige un país de primer mundo donde se hable inglés comúnmente (por ejemplo, Australia, Francia, EE. UU.)',
      subtitleSuffix: ' para enfocar tu búsqueda.',
